...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-postcss-scss/node_modules/postcss-scss/lib/nested-declaration.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/nested-declaration.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/</a> &#187; nested-declaration.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function NestedDeclaration(defaults) {</span>
<span class="cstat-no" title="statement not covered" >        _classCallCheck(this, NestedDeclaration);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _this = _possibleConstructorReturn(this, _Container.call(this, defaults));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _this.type = 'decl';</span>
<span class="cstat-no" title="statement not covered" >        _this.isNested = true;</span>
<span class="cstat-no" title="statement not covered" >        if (!_this.nodes) <span class="cstat-no" title="statement not covered" >_this.nodes = [];</span></span>
