...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-postcss-scss/node_modules/postcss-scss/lib/scss-parse.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/scss-parse.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/</a> &#187; scss-parse.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function scssParse(scss, opts) {</span>
<span class="cstat-no" title="statement not covered" >    var input = new _input2.default(scss, opts);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var parser = new _scssParser2.default(input);</span>
<span class="cstat-no" title="statement not covered" >    parser.tokenize();</span>
<span class="cstat-no" title="statement not covered" >    parser.loop();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return parser.root;</span>
}
