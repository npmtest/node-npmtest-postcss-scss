...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-postcss-scss/node_modules/postcss-scss/lib/scss-stringifier.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/scss-stringifier.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-postcss-scss/node_modules/postcss-scss/lib/</a> &#187; scss-stringifier.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function ScssStringifier() {</span>
<span class="cstat-no" title="statement not covered" >        _classCallCheck(this, ScssStringifier);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _possibleConstructorReturn(this, _Stringifier.apply(this, arguments));</span>
    }
&nbsp;
    ScssStringifier.prototype.comment = <span class="fstat-no" title="function not covered" >function comment(node) {</span>
<span class="cstat-no" title="statement not covered" >        var left = this.raw(node, 'left', 'commentLeft');</span>
<span class="cstat-no" title="statement not covered" >        var right = this.raw(node, 'right', 'commentRight');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.raws.inline) {</span>
<span class="cstat-no" title="statement not covered" >            var text = node.raws.text || node.text;</span>
<span class="cstat-no" title="statement not covered" >            this.builder('//' + left + text + right, node);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.builder('/*' + left + node.text + right + '*/', node);</span>
        }
    };
&nbsp;
    ScssStringifier.prototype.decl = <span class="fstat-no" title="function not covered" >function decl(node, semicolon) {</span>
<span class="cstat-no" title="statement not covered" >        if (!node.isNested) {</span>
<span class="cstat-no" title="statement not covered" >            _Stringifier.prototype.decl.call(this, node, semicolon);</span>
        } else {
&nbsp;
<span class="cstat-no" title="statement not covered" >            var between = this.raw(node, 'between', 'colon');</span>
<span class="cstat-no" title="statement not covered" >            var string = node.prop + between + this.rawValue(node, 'value');</span>
<span class="cstat-no" title="statement not covered" >            if (node.important) {</span>
<span class="cstat-no" title="statement not covered" >                string += node.raws.important || ' !important';</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.builder(string + '{', node, 'start');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var after = void 0;</span>
<span class="cstat-no" title="statement not covered" >            if (node.nodes &amp;&amp; node.nodes.length) {</span>
<span class="cstat-no" title="statement not covered" >                this.body(node);</span>
<span class="cstat-no" title="statement not covered" >                after = this.raw(node, 'after');</span>
            } else {
<span class="cstat-no" title="statement not covered" >                after = this.raw(node, 'after', 'emptyBody');</span>
            }
<span class="cstat-no" title="statement not covered" >            if (after) <span class="cstat-no" title="statement not covered" >this.builder(after);</span></span>
<span class="cstat-no" title="statement not covered" >            this.builder('}', node, 'end');</span>
        }
    };
&nbsp;
